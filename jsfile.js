...
document.getElementById("2").style.transform="translate(0px,0)"
document.getElementById("3").style.transform="translate(0px,0)"
document.getElementById("4").style.transform="translate(0px,0)"
...
switch(clicked) {
    case "t1":
        ...
        a1.style.color="#C38FFF"
        v1.style.display="flex"
        
  

      a2.style.color="#03DAC6"
        v2.style.display="none"
       


    a3.style.color="#03DAC6"
    v3.style.display="none"
  



     a4.style.color="#03DAC6"
    v4.style.display="none"
       ...
       case "t2":
        ...
        a2.style.color="#C38FFF"
        v2.style.display="flex"

      a1.style.color="#03DAC6"
